                      ...
                      TextButton(
                        ...
                        onPressed: () async {
                          ...
                          await cloud_firebase.FirebaseFirestore.instance
                              ...
                              .update({
                            "verify_received":
                                cloud_firebase.FieldValue.increment(1),
                            "verifiers": cloud_firebase.FieldValue.arrayUnion(
                                [user!.uid])
                          });
                          if (!widget.doc.get("admin_required")) {
                            await cloud_firebase.FirebaseFirestore.instance
                                .collection('claims')
                                .doc(widget.doc.get('uuid'))
                                .get()
                                .then((value) {
                              if (value.data()?['verify_received'] >=
                                  value.data()?['verify_required']) {
                                cloud_firebase.FirebaseFirestore.instance
                                    .collection('claims')
                                    .doc(widget.doc.get('uuid'))
                                    .update({"claim_status": 1});
                                payout();
                              }
                            });
                          }
                      ...
                      TextButton(
                        ...
                        onPressed: () async {
                          await cloud_firebase.FirebaseFirestore.instance
                              ...
                              .doc(widget.doc.get('uuid'))
                              .update({
                            "deniers": cloud_firebase.FieldValue.arrayUnion(
                                [user!.uid]),
                          });
                        },
                      ),
