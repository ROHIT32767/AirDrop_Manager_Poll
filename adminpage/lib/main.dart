...
import 'package:adminpage/InsuranceAdd/insurance_claim.dart';
import 'package:adminpage/ClaimApproval/page.dart';
import 'package:adminpage/AirDrop/insurance_options.dart';
...
void main() async {
  ...
  runApp(MaterialApp(
    ...
    routes: {
      ...
      'insurance_add': (context) => const InsuranceAddScreen(),
